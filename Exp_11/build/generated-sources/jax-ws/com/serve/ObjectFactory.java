 ...
 * generated in the com.serve package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://Default/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://Default/", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.serve
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Default/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Default/", name = "operationResponse")
